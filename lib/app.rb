...
class TheatreManager
  ...
  def run_main_menu
    run_menu_and_call_next(main_menu)
  end
  
  def run_theatre_menu
    run_menu_and_call_next(theatre_menu)
  end
  
  def run_analyze_menu
    run_menu_and_call_next(analyze_menu)
  end
  
  def run_loc_time_menu
    run_menu_and_call_next(loc_time_menu)
  end
  
  def run_movie_menu
    run_menu_and_call_next(movie_menu)
  end
  ...
  def main_menu
      ...
      main.add_menu_item({key_user_returns: 1, user_message: "Work with movies.", do_if_chosen:  ["run_movie_menu"]})
      main.add_menu_item({key_user_returns: 2, user_message: "Work with theatres.", do_if_chosen: ["run_theatre_menu"]})
      main.add_menu_item({key_user_returns: 3, user_message: "Schedule movie time slots by theatre.", do_if_chosen: ["run_loc_time_menu"]})
      main.add_menu_item({key_user_returns: 4, user_message: "Run an analysis on my theatres.", do_if_chosen: ["run_analyze_menu"]})
      main
  end
  ...
  def movie_menu
      ...
      movie.add_menu_item({key_user_returns: 2, user_message: "Update a movie.", do_if_chosen: ["update_object", Movie, "run_movie_menu"]})
      movie.add_menu_item({key_user_returns: 3, user_message: "Show me movies.", do_if_chosen: ["show_object", Movie, "run_movie_menu"]})
      movie.add_menu_item({key_user_returns: 4, user_message: "Delete a movie.", do_if_chosen: ["delete_object", Movie, "run_movie_menu"]})
  ...
  def theatre_menu
      ...
      theatre.add_menu_item({key_user_returns: 2, user_message: "Update a theatre.", do_if_chosen: ["update_object", Location, "run_theatre_menu"]})
      theatre.add_menu_item({key_user_returns: 3, user_message: "Show me theatres.", do_if_chosen: ["show_object", Location, "run_theatre_menu"]})
      theatre.add_menu_item({key_user_returns: 4, user_message: "Delete a theatre.", do_if_chosen: ["delete_object", Location, "run_theatre_menu"]})
